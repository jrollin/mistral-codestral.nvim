...
- **[quick-start.md](quick-start.md)** - 30-second verification
...
- **Quick verification (30 seconds):** See [quick-start.md](quick-start.md)
- **Comprehensive testing:** See [testing-guide.md](testing-guide.md)
