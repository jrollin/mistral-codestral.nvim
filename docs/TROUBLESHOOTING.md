...
1. **Open the test file:**
   ```bash
   nvim <plugin-dir>/tests/fixtures/step-by-step-test.js
   ```
...
```vim
:luafile <plugin-dir>/scripts/debug_completion.lua
:DiagnoseMistral
```
...
nvim --headless -u ~/.config/nvim/init.lua \
  -c "luafile <plugin-dir>/tests/integration_test.lua" 2>&1
```
...
**Quick test:**
1. Open: `nvim <plugin-dir>/tests/fixtures/step-by-step-test.js`
2. Go to Test 1
...
**See also:**
- [testing-guide.md](testing-guide.md) - Comprehensive testing methodology
- [quick-start.md](quick-start.md) - Quick verification tests
